...
public class CxfRsProducerExceptionTest extends CamelSpringTestSupport {
    ...
    public void testRestServerDirectlyAddCustomer() {
        ...
        String response = template.requestBodyAndHeader("cxfrs:http://localhost:9002/customerservice/customers?throwExceptionOnFailure=true",
